...
public class Explosives {
	...
	/*
	 * @ public invariant // Prop 1 le nombre de incompatibilités doivent être
	 * entre 0 et 49
	 * 
	 * @ (0 <= nb_inc && nb_inc < 50);
	 * 
	 ...
	 */
	/*
	 * @ public invariant // Prop 2 le nombre de affectations doivent être
	 * entre 0 et 29
	 * 
	 ...
	 */
	/*
	 * @ public invariant // Prop 3 le tableau d'incompatibilités doit contenir
	 * que des produits
	 * 
	 ...
	 */
	/*
	 * @ public invariant // Prop 4 la premier colonne du tableau doit contenir
	 * un batîment et la deuxième doit contenir un produit
	 * 
	 ...
	 */
	/*
	 * @ public invariant // Prop 5 un produit peut pas être incompatible avec
	 * lui même
	 * 
	 * @ (\forall int i; 0 <= i && i < nb_inc;
	 ...
	 */
	/*
	 * @ public invariant // Prop 6 si un produit i est incompatible avec un
	 * produit j donc le produit j est incompatible avec le produit i
	 * 
	 * @ (\forall int i; 0 <= i && i < nb_inc;
	 * 
	 ...
	 */
	/*
	 * @ public invariant // Prop 7 les produits dans le même batîment ne sont
	 * pas incompatibles.
	 * 
	 * @ (\forall int i; 0 <= i && i < nb_assign;
	 * 
	 ...
	 */
	/*
	 * @ public invariant // Prop 8 toutes les lignes du tableau des
	 * affectations sont differentes deux a deux
	 * 
	 ...
	 * 
	 * @
	 * (!(assign[i][0].equals(assign[j][0])))||(!(assign[i][1].equals(assign[j][
	 * 1])))));
	 * 
	 * @
	 * 
	 ...
	 */
	/*
	 * @ public invariant // Prop 9 un produit ne peut pas etre stocke dans plus
	 * de trois batiments
	 * 
	 * @ (\forall int i; 0 <= i && i < nb_assign-1;
	 * 
	 * @ (\num_of int j;i<j && j< nb_assign;((assign[i][1]).equals(assign
	 * [j][1])))<3);
	 * 
	 * @
	 * 
	...
	// @ ensures nb_inc > \old(nb_inc); // Prop 10 le nombre d'incompatibilites
	// ne peut jamais diminuer
	// @ requires (0 <= nb_inc && nb_inc < 50);
	// @ requires prod1.startsWith("Prod") && prod2.startsWith("Prod");
	// @ requires !prod1.equals(prod2);
	// @ requires (\forall int i; 0 <= i && i < nb_inc; (\exists int j; 0 <= j
	// && j < nb_inc; (incomp[i][0]).equals(incomp[j][1]) &&
	// (incomp[j][0]).equals(incomp[i][1])));
